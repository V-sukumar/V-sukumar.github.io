...
const Skills = () => {
  return (
    <div id="skills">
      <Box m={"auto"}w={"90%"}>
      <Heading fontFamily={'Ubuntu, sans-serif'} fontSize={50} fontWeight={700} mt={100}><i>Skills </i></Heading> 

      <Grid fontFamily={'Ubuntu, sans-serif'} className='card' templateColumns={{
              base: "repeat(2, 1fr)",
              sm: "repeat(3, 1fr)",
              md: "repeat(4, 1fr)",
              lg: "repeat(6, 1fr)",
        ...
        <GridItem className="skills-card" >
          <Box _hover={{ transform: "scale(1.2)", cursor:"pointer" }} transition={"0.2s ease-in-out"} border={'4px solid #4CBB17'} borderRadius={20} w={150} m={"auto"} p={5}>
        ...
        <GridItem className="skills-card">
        <Box _hover={{ transform: "scale(1.2)", cursor:"pointer" }} transition={"0.2s ease-in-out"} border={'4px solid #4CBB17'} borderRadius={20} w={150} m={"auto"} p={5}>
          <Image m={"auto"} class="skills-card-img"  src="./Styled icon.png"/>
